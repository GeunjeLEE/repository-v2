from spaceone.api.repository.v2 import schema_pb2, schema_pb2_grpc
from spaceone.core.pygrpc import BaseAPI
from cloudforet.repository.service.schema_service import SchemaService
from cloudforet.repository.info.schema_info import SchemaInfo, SchemasInfo
from cloudforet.repository.info.common_info import EmptyInfo, StatisticsInfo
...
class Schema(BaseAPI, schema_pb2_grpc.SchemaServicer):
    ...
    def sync(self, request, context):
        params, metadata = self.parse_request(request, context)
        with self.locator.get_service(SchemaService, metadata) as schema_svc:
            schema_data = schema_svc.sync(params)
            return self.locator.get_info(SchemaInfo, schema_data)
